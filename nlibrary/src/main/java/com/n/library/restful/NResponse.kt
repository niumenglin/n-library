...
open class NResponse<T> {
    companion object {
        ...
        val RC_NOT_PURCHASED = 5004 //未购买本课程，或用户ID有误
        val RC_CHECK_SERVER_ERROR = 5005 //效验服务报错
        val RC_USER_NAME_EXISTS = 5006 //此用户名被暂用
        val RC_HTML_INVALID = 8001 //请输入HTML
        val RC_CONFIG_INVALID = 8002 //请输入配置

        val RC_USER_FORBID = 6001 //用户身份非法，如有疑问可进入课程官网群联系管理员
